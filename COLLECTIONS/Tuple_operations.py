...
if(n==1):
  ...
  r=str(input("enter the tuple name which to be repeated : "))
  rn=int(input("enter no of times the tuple to be repeated : "))
  if(r=='t1'):
    print("tuple1 repetition : ",t1*rn)
  else:
    print("tuple2 repetition : ",t2*rn)
elif(n==4):
  ...
  print("all elements except the last 5 of t1 : ",t1[:-5])
elif(n==9):
  print("last element of tuple t1 : ",t1[-1])
elif(n==10):
  print("reversed the order of tuple : ",t1[::-1])
elif(n==11):
  print("elements from index 2 to 5 in t1: ",t1[2:6])
elif(n==12):
  print("portion of an element in t1 : ",t1[3][:5])
elif(n==13):
